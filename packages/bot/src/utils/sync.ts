  ...
  public static async sendQrRequest(dbGuild: G, dbUser: U, member: GuildMember) {
    ...
    try {
      await member.send(
        ...
        + `Для этого нужно установить прикрепленное ниже изображение с QR-кодом на аватар в настройках Uplay и после смены ввести команду \`$verify\` в ЛС <@425291995565785091>\n`
        + `\n`
